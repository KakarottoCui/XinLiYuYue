     ...
     <div class="side_list">
      <div class="widget-header header-color-green2">
       ...
       <div class="product_info clearfix">
          ...
          <img src="/mindSubscribe/mutualResource/images/${doctor.img}"  width="210px" height="200px"/>
          </c:if>
       
       
     <%-- <a href="#" class="img_link"><img src="/mindSubscribe/mutualResource/images/${doctor.img}"  width="210" height="200"/></a> --%>
